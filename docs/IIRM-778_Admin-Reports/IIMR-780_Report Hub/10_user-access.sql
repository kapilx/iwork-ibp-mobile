-- ============================================================================
-- Report: User Access
-- name (used in URL/endpoint): user-access    |    id: 10    |    order_no: (none -- sorts last)
-- end_point: user-access
-- created_at: 2025-08-02 10:09:56.62745    updated_at: 
...
-- ------------------------------------------------------------------
-- 1. MAIN QUERY  (admin_reports.query, id = 10)
-- ------------------------------------------------------------------
-- To update, edit the query text below and run:
--   UPDATE admin_reports SET query = $Q$select create_by, operation, created_at from vr_user_access where created_at::date BETWEEN ###START_DATE###::date and ###END_DATE###::date order by create_by, operation, created_at$Q$
--   WHERE id = 10;

select create_by, operation, created_at from vr_user_access where created_at::date BETWEEN ###START_DATE###::date and ###END_DATE###::date order by create_by, operation, created_at

-- ------------------------------------------------------------------
-- 2. FILTER PARAMETERS  (admin_reports_parameters WHERE admin_report_id = 10)
-- ------------------------------------------------------------------
-- Filter: Start Date
...
-- ------------------------------------------------------------------
-- 3. RESULT COLUMN MAPPINGS  (admin_reports_results_mappings WHERE admin_report_id = 10)
-- ------------------------------------------------------------------
--   operation                    -> Action                         (variable: operation, type: string, align: default)
--   created_at                   -> Time of Action                 (variable: createdAt, type: date, align: default)
