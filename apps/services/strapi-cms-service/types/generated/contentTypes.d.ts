...
export interface ApiCompanyTemplateCompanyTemplate
  extends Struct.CollectionTypeSchema {
  collectionName: 'company_templates';
  info: {
    displayName: 'Company Template';
    pluralName: 'company-templates';
    singularName: 'company-template';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    companyId: Schema.Attribute.String & Schema.Attribute.Required;
    config: Schema.Attribute.Component<
      'company-template.company-template-config',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiHelloWorldHelloWorld extends Struct.CollectionTypeSchema {
  collectionName: 'hello_worlds';
  info: {
    description: 'A simple Hello World content type';
...
export interface ApiPolicyTemplatePolicyTemplate
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    companyId: Schema.Attribute.String & Schema.Attribute.Required;
    config: Schema.Attribute.Component<
      'policy-template.policy-template-config',
      false
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    > &
      Schema.Attribute.Private;
    policyId: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTermsAndConditionsTermsAndCondition
  extends Struct.CollectionTypeSchema {
  collectionName: 'terms_and_conditions';
  info: {
    description: 'Versioned terms and conditions documents with sections';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    effectiveDate: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::terms-and-conditions.terms-and-condition'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<
      'terms-and-conditions.tc-section',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUserAuditUserAudit extends Struct.CollectionTypeSchema {
  collectionName: 'user_audits';
  info: {
    description: 'Track all user login/logout activities and important actions for audit trail';
    displayName: 'User Audit';
    pluralName: 'user-audits';
    singularName: 'user-audit';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    activity: Schema.Attribute.Enumeration<
      [
        'login',
        'logout',
        'session_replaced',
...
export interface ApiUserSessionUserSession extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Track current active user status - ONE RECORD PER USER ONLY (no historical data)';
    displayName: 'Current User Status';
  ...
  attributes: {
    ...
    session_metadata: Schema.Attribute.JSON;
    start_time: Schema.Attribute.DateTime & Schema.Attribute.Required;
    token_hash: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_agent: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::company-template.company-template': ApiCompanyTemplateCompanyTemplate;
      'api::hello-world.hello-world': ApiHelloWorldHelloWorld;
      'api::policy-template.policy-template': ApiPolicyTemplatePolicyTemplate;
      'api::terms-and-conditions.terms-and-condition': ApiTermsAndConditionsTermsAndCondition;
      'api::user-audit.user-audit': ApiUserAuditUserAudit;
