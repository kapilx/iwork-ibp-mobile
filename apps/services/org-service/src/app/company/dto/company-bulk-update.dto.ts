...
export class CompanyFieldUpdateDto {
  @IsNotEmpty()
  @IsString()
  fieldName!: string;
...
/**
 * DTO for company bulk update request
 */
export class CompanyBulkUpdateDto {
...
/**
 * DTO for company bulk update response
 */
export class CompanyBulkUpdateResponseDto {
