...
@Entity("policy_asset_endorsement")
export class PolicyAssetEndorsement {
  ...
  @Column({ name: "endorsement_asset_count", type: "int", default: 0 })
  endorsmentAssetCount!: number;

  @Column({ name: "endorsment_sub_asset_count", type: "int", default: 0 })
  endorsmentSubAssetCount!: number;
  ...
  @Column({
    name: "endorsement_addition_count",
    type: "int",
    default: 0,
  })
  endorsementAdditionCount!: number;

  @Column({
    name: "endorsement_deletion_count",
    type: "int",
    default: 0,
  })
  endorsementDeletionCount!: number;
  ...
  @Column({ name: "enabled_for_performance_lid", type: "int", default: 9402 })
