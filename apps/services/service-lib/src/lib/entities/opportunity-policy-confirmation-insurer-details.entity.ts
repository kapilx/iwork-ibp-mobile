...
@Entity("opportunity_policy_confirmation_insurer_map")
export class OpportunityPolicyConfirmationInsurerMap {
  @PrimaryGeneratedColumn({ name: "id", type: "int" })
  id: number;

  @Column({ name: "policy_confirmation_id", type: "int" })
  ...
  @ManyToOne(
    ...
    (policyConfirmation) => policyConfirmation.insurerDetails
  )
