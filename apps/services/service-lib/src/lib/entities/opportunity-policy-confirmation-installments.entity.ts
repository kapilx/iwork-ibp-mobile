...
/**
 * Entity for opportunity_policy_confirmation_installments table.
 */
@Entity("opportunity_policy_confirmation_installments")
export class OpportunityPolicyConfirmationInstallments {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(
    ...
    (policyConfirmation) => policyConfirmation.installmentDetails
  )
  @JoinColumn({ name: "policy_confirmation_id" })
  policyConfirmation: OpportunityPolicyConfirmation;
}
