...
/**
 * Entity for opportunity_placement_slip_installments table.
 */
@Entity("opportunity_placement_slip_installments")
export class OpportunityPlacementSlipInstallments {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(
    ...
    (placement) => placement.installmentDetails
  )
