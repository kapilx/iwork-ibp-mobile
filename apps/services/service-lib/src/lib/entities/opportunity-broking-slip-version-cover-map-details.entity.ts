...
@Entity("opportunity_broking_slip_version_cover_map_details")
export class BrokingSlipVersionCoverDetails {
  @PrimaryGeneratedColumn()
  id!: number;
  ...
  @Column({ name: "broking_slip_version_id", type: "int", nullable: false })
  ...
  @ManyToOne(
    ...
    (brokingSlip) => brokingSlip.coverDetails,
    {
      nullable: false,
      onDelete: "CASCADE",
    }
  )
  @JoinColumn({ name: "broking_slip_version_id" })
  brokingSlipVersion?: Relation<BrokingSlipVersionDetails>;
}
