...
/**
 * Entity for opportunity_held_cover_note_installments table.
 */
@Entity("opportunity_held_cover_note_installments")
export class OpportunityHeldCoverNoteInstallments {
  @PrimaryGeneratedColumn()
  id: number;
  ...
  @ManyToOne(
    ...
    (heldCoverNote) => heldCoverNote.installmentDetails
  )
