...
export class OpportunityFieldUpdateDto {
  @IsNotEmpty()
  @IsString()
  fieldName!: string;
...
/**
 * DTO for opportunity bulk update request
 * Supports bulk updating of ownerId, isgId, statusLid, and expiryDate fields
 */
export class OpportunityBulkUpdateDto {
...
/**
 * DTO for opportunity bulk update response
 */
export class OpportunityBulkUpdateResponseDto {
