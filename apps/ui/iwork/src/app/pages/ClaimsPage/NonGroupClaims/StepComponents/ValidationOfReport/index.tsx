...
export interface ValidationOfReportPayload {
  body: any;
  // add more typed fields as needed
}

// Methods parent can call via ref
export interface ValidationOfReportHandle {
  getPayload: () => ValidationOfReportPayload;
...
ValidationOfReport.displayName = "ValidationOfReport";

export default ValidationOfReport;
