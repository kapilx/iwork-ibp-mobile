...
export interface CustomerAgreementPayload {
  body: any;
  // add more typed fields as needed
}

// Methods parent can call via ref
export interface CustomerAgreementHandle {
  getPayload: () => CustomerAgreementPayload;
...
CustomerAgreement.displayName = "CustomerAgreement";
