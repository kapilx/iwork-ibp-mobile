...
import { ENDORSEMENT_STEP_KEYS, UPLOAD_CATEGORY } from "../../../constants/index";
import {
...
export const transactionTypeKeyUtility = (data: any) => {
...
export const CreateEndorsementConfig = (
  ...
  ...(showPremiumCalculator && endorsementType === "FINANCIAL_ENDORSEMENT"
    ? [
        {
          key: "premiumCalculator",
          title: (
            <TitleContainer>
              <TitleTypography>Premium Calculator</TitleTypography>
            </TitleContainer>
          ),
          containerStyles: {
            display: "flex",
          ...
          config: [
            {
              key: "premiumCalculatorDownload",
              name: "premiumCalculatorDownload",
              label: "Download",
              type: "customcomponent",
              gridColumn: 9,
              componentProps: {
                componentKey: "PremiumCalculatorDownload",
              },
            },
          ],
        },
...
export const endorsementProcessConfig: Step[] = [
  ...
  {
    key: ENDORSEMENT_STEP_KEYS.TPA_ID_UPLOAD,
    title: "TPA ID Upload",
    config: TpaIdUploadConfig,
    stepState: StateEnum.DRAFT,
  },
];
...
export const endorsementDetailsBreadcrumbConfig = (breadcrumbNavigationState: {
...
}) => [
  {
    ...
    state: { filters: breadcrumbNavigationState?.filters || {} },
  },
  { label: "Endorsement details" },
];
    ...
    config: [
      {
        ...
        componentProps: {
          ...
          creationLabel: creationLabel,
          isGroupPolicyType: isGroupPolicyType,
          showPremiumCalculator: showPremiumCalculator,
...
export const inceptionProcessConfig: Step[] = [
  ...
  },
  {
    key: ENDORSEMENT_STEP_KEYS.TPA_ID_UPLOAD,
    title: "TPA ID Upload",
    config: TpaIdUploadInceptionConfig,
    stepState: StateEnum.DRAFT,
  },
];
