// Columns / KPIs / filter fields for Client Portfolio Enhanced.
// A copy of ClientPortfolio/CompanyOverView/tableConfig.ts so the original
// screen is fully insulated from any change made here.
...
export const clientPortfolioEnhancedBreadcrumbs = [
  {
    label: "Dashboard",
    path: "/dashboard",
  },
  {
    label: "My client portfolio enhanced",
  },
];
