export const handOverMeetingConfig = [
  {
    key: "handOverMeetFields",
    title:
      "Select the hand over meet details or select from existing meetings from the following list",
    config: [
      {
        key: "handOverMeetingTypeLid",
      ...
      },
      {
        ...
        rules: {
          validate:
            '#validateRequiredIfEqual("handOverMeetingTypeLid", ${SELECT_MEETING_EXISTING_MEETING}, "Please select a meeting.")',
        },
        gridColumn: 5,
        componentProps: {
        ...
        apiDependencies: {
          ...
          showCondition:
            '#(watch) => !!watch("handOverMeetingTypeLid") && watch("handOverMeetingTypeLid") === ${SELECT_MEETING_EXISTING_MEETING}',
    ...
    defaultValues: {
      ...
      availableFrom: null,
      selectMeeting: null,
      meetingTypeLid: "#${MEETING_TYPE_HANDOVER}",
      locationTypeLid: null,
      handOverMeetingTypeLid: "#${SELECT_MEETING_NEW_MEETING}",
    },
    containerStyles: {
      gap: "16px",
      display: "flex",
    ...
    config: [
      {
        ...
        rules: {
          ...
          validate:
            '#(value) => { return (value.length <= 1000 || "Should not exceed 1000 characters.")}',
        },
        gridColumn: 9,
        componentProps: {
          rows: 3,
